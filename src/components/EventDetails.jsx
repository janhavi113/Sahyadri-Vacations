...
function EventDetails() {
  ...
  const getCurrentrecord = async () => {
    fetch(`https://sahyadri-vacations-5e5s.vercel.app/create-event/event-details/:${eventId}`, {
      method: "GET", headers: {
  ...
  const onDelete = async (data) => {
    let r = await fetch(`https://sahyadri-vacations-5e5s.vercel.app/create-event/event-details/:${eventId}`,
      {
        method: "POST", headers: {
          "Content-Type": "application/json",
  ...
  const handleUpload = async (data) => {
    ...
    const url = `https://sahyadri-vacations-5e5s.vercel.app/create-event/event-details/:${eventId}`;
