    ...
    <div className="ceo-section ">
      <div className="ceo-section-team row">
        ...
        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 founder py-5">
          ...
          With an MBA background, He has combined his management expertise and passion for travel to build a company that emphasizes quality, innovation, and sustainable tourism.” His mission is crafting unforgettable journeys that connect people with nature and adventure. As the founder of Sahyadri Vacations and Adventures, He has explored more than 350 treks in Sahyadri mountain ranges and travel a lot in all over India. With a love for adventure and exploration, He leads a team who inspire others to step out of their comfort zones and experience the world through trekking and travel.  He is great leader and Mountaineer is deeply passionate about traveling and believe that every journey has the power to transform lives, broaden horizon and main tool to improve World Happiness Index. </p>
