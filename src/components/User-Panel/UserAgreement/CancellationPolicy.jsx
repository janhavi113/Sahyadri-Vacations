                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div style={{'font-style': 'italic'}}>
                               <span style={{'font-style': 'italic','font-weight': 'bold','color': 'red'}}> Note - </span> We need at least 12 participants to run that particular trek/trip, if batch size is not enough then organisers have all right to Postpone,Collaborate with other Companies or Cancel the trek. In this scenario,You will receive your booking amount in 2-3 working days.
