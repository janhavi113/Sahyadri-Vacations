            ...
            <div className="team justify-content-around" >
              ...
              <div className="row justify-content-around">
                ...
                <div className="mt-2 team-members col-lg-3 col-md-3 col-sm-3">
                  <div className="bg-transparent text-center" style={{ "border": "none;" }}>
                    <img src={multiimage2} className="card-img-top" alt="Nanda Diwate Trek Leader" />
                    <div className="card-body all-team">
                      <h5 className="card-title">Nanda Diwate</h5>
                ...
                <div className="mt-2 team-members col-lg-3 col-md-3 col-sm-3">
                  <div className="bg-transparent text-center" style={{ "border": "none;" }}>
                    <img src={multiimage2} className="card-img-top" alt="Ashwini Jamthe Trek Leader" />
                    <div className="card-body all-team">
                      <h5 className="card-title">ashwini Jamthe</h5>
                      <p className="card-text">Trek Leader 🌄 </p>
                      <a href="#" className="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                          <g id="Group_789" data-name="Group 789" transform="translate(-1385 -625)">
